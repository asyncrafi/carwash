...
@shared_task
def send_welcome_email_task(user_id, email, first_name):
    send_email_task.delay(
        subject="Welcome to CarWash!",
        email_to=email,
        template_name="emails/welcome.html",
        context={"name": first_name, "user_id": user_id},
    )


@shared_task
def send_otp_email_task(email, code, first_name):
    send_email_task.delay(
...
@shared_task
def send_password_reset_email_task(email, code, first_name):
    send_email_task.delay(
...
@shared_task
def send_provider_approved_email_task(email, first_name):
    send_email_task.delay(
